...
#
# Generated by Vivado on Sat Oct 15 23:25:41 +0200 2022
...
#
#    "D:/VIDEO_SCALER_2_0_0/src/fifo/src/ea_tdp_ram.vhd"
#    "D:/VIDEO_SCALER_2_0_0/src/fifo/src/p_fifo.vhd"
#    "D:/VIDEO_SCALER_2_0_0/src/fifo/src/ea_fifo.vhd"
#    "D:/VIDEO_SCALER_2_0_0/test/fifo/tbench/tb_fifo.vhd"
#
#*****************************************************************************************
...
# Create project
create_project -f ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7a200tfbg676-2
...
set files [list \
 [file normalize "${origin_dir}/../../src/fifo/src/ea_tdp_ram.vhd"] \
 [file normalize "${origin_dir}/../../src/fifo/src/p_fifo.vhd"] \
 [file normalize "${origin_dir}/../../src/fifo/src/ea_fifo.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../src/fifo/src/ea_tdp_ram.vhd"
...
set file "$origin_dir/../../src/fifo/src/p_fifo.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/../../src/fifo/src/ea_fifo.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL 2008" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set files [list \
 [file normalize "${origin_dir}/../../src/fifo/tbench/tb_fifo.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/../../src/fifo/tbench/tb_fifo.vhd"
set file [file normalize $file]
...
set_property -name "top" -value "tb_fifo" -objects $obj
